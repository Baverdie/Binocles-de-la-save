        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <motion.div
              ...
              className="relative aspect-4/5 max-h-[50vh] sm:max-h-none rounded-2xl overflow-hidden mx-auto w-full max-w-sm sm:max-w-none"
            >
              {photos.map((src, i) => (
                <Image
                  key={src}
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {valeurs.map((valeur, index) => (
              <motion.div
                ...
                className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl text-center"
              >
