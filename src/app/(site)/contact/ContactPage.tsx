...
export default function ContactPage() {
  ...
  function handleChange(
    ...
    if (name === "telephone") {
      ...
      setForm((prev) => ({ ...prev, format: value, duree: value === "essai" ? "" : prev.duree }));
    } else {
            ...
            >
              {options.map((option, index) => {
                const content = (
                  ...
                  >
                    <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl h-full transition-shadow duration-300 max-lg:shadow-md hover:shadow-xl flex flex-col items-center text-center">
            ...
            >
              ...
              {status === "success" ? (
                <motion.div
                  ...
                  transition={{ duration: 0.4 }}
                  className="bg-white p-8 sm:p-10 rounded-2xl text-center"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="essai">Lentilles à l&apos;essai</option>
                      </select>
                    </div>
                    <div className={form.format === "essai" ? "opacity-50" : ""}>
                      <label
                        htmlFor="duree"
                        className="block text-xs text-brown/50 mb-1.5 ml-1"
                      >
                      ...
                      <select
                        ...
                        name="duree"
                        required
                        disabled={form.format === "essai"}
                        value={form.duree}
                        onChange={handleChange}
                        className={`${inputClasses} appearance-none bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2212%22%20height%3D%2212%22%20viewBox%3D%220%200%2012%2012%22%3E%3Cpath%20fill%3D%22%23412A1C%22%20fill-opacity%3D%220.3%22%20d%3D%22M2%204l4%204%204-4%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-position-[right_1rem_center] ${form.format === "essai" ? "cursor-not-allowed" : "cursor-pointer"}`}
                      >
                        <option value="" disabled>
                          Choisir une durée
                        </option>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      />
                      <span
                        className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-colors ${form.besoinProduit
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      />
                      <span
                        className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-colors ${aMutuelle
                            ? "border-accent bg-accent"
                            : "border-brown/20 bg-white"
                          }`}
                      >
