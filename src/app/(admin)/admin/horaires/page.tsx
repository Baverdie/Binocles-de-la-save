							...
							<div className="col-span-3 flex items-center gap-2">
								<label className="flex items-center text-xs text-brown/60 cursor-pointer">
									<input
										...
										className="h-4 w-4 rounded-lg border-brown/30 text-brown focus:ring-brown cursor-pointer"
									/>
								</label>
								<input
									type="time"
						...
						<div className="flex items-center justify-between">
							<label className="flex items-center gap-2 text-xs text-brown/60 cursor-pointer">
								<input
									...
									className="h-4 w-4 rounded-lg border-brown/30 text-brown cursor-pointer"
								/>
