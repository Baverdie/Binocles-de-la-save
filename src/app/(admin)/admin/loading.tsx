        ...
        {[...Array(4)].map((_, i) => (
          ...
          >
            ...
            <div>
              ...
              <div className="h-3 w-24 bg-brown/5 rounded-lg mt-1.5" />
            </div>
          </div>
        ))}
      </div>
          ...
          >
            ...
            <div className="space-y-3">
              {[...Array(3)].map((_, j) => (
                ...
                >
                  <div>
                    <div className="h-4 w-28 bg-brown/10 rounded-lg" />
                    <div className="h-3 w-40 bg-brown/5 rounded-lg mt-1.5" />
                  </div>
                  <div className="h-3 w-12 bg-brown/5 rounded-lg" />
                </div>
              ))}
            </div>
          </div>
