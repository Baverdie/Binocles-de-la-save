        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {engagements.map((item, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-brown p-5 sm:p-6 md:p-8 rounded-2xl h-full transition-shadow duration-300 max-lg:shadow-md hover:shadow-xl overflow-hidden relative flex flex-col">
