...
export default function PresentationSection() {
  ...
  return (
    <section ref={ref} className="relative py-16 md:py-24 lg:py-32 px-4 sm:px-6 bg-beige overflow-hidden">
      {/* Background decorations with focus animations */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Large circle top right - breathing blur animation */}
        <motion.div
        ...
        />
        {/* Small circle bottom left - focus pulse */}
        <motion.div
        ...
        />
        {/* Medium circle center left - slow drift */}
        <motion.div
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            <div className="relative">
              {/* Image container with lens-like border */}
