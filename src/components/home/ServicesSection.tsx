        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-beige p-4 sm:p-6 md:p-8 text-center rounded-2xl h-full transition-all duration-500 max-lg:shadow-md hover:shadow-xl overflow-hidden relative flex flex-col">
