      ...
      <div className="relative max-w-5xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20">
          ...
          >
            ...
            >
              <iframe
                srcDoc={`<!DOCTYPE html><html><head><meta charset="utf-8"><link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"/><style>*{margin:0;padding:0;box-sizing:border-box}html,body,#map{width:100%;height:100%;background:#f5efe8}.leaflet-control-attribution{display:none!important}.leaflet-control-zoom a{background:#fff;color:#412A1C;border-color:#e0d5cc}</style></head><body><div id="map"></div><script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script><script>const map=L.map('map',{zoomControl:true,scrollWheelZoom:false}).setView([43.66633,1.194249],15);L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png',{maxZoom:19}).addTo(map);L.circleMarker([43.66633,1.194249],{radius:9,fillColor:'#412A1C',color:'#E7DAC6',weight:2.5,fillOpacity:1}).addTo(map);</script></body></html>`}
                width="100%"
                height="100%"
              ...
              />
              <a
                href="https://www.google.com/maps/dir/?api=1&destination=42+Avenue+de+la+R%C3%A9publique+31530+Levignac"
                target="_blank"
                rel="noopener noreferrer"
                className="absolute bottom-3 right-3 flex items-center gap-1.5 bg-white/90 hover:bg-white text-brown text-xs font-medium px-3 py-1.5 rounded-full shadow-sm transition-colors"
              >
