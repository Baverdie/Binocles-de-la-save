...
/** Vérifie le state signé et retourne l'adminId si valide (expire après 10 min) */
...
/** Crée le calendrier dédié "Binocles - RDV" et retourne son ID */
...
/** Crée un événement Google Calendar pour un RDV */
...
/** Récupère le premier admin connecté à Google Calendar */
